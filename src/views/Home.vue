<template>
  <div>
    <div class="section no-pad-bot" id="index-banner">
      <div class="container">
        <br><br>
        <h1 class="header center">Books Store</h1>
        <div class="row center">
          <h5 class="header col s12 light">We have all books you need! Let's check it?</h5>
        </div>
        <div class="row center">
          <router-link id="download-button" class="btn-large waves-effect waves-light btn-secondary" :to="'/catalog'">
            Go to catalog
          </router-link>
        </div>
      </div>
    ...
    <div class="container">
      <div class="section">
        ...
        <div class="row">
          ...
          <div class="col s12 m4">
            <div class="icon-block">
              <h2 class="center"><i class="material-icons">all_inclusive</i></h2>
          ...
          <div class="col s12 m4">
            <div class="icon-block">
              <h2 class="center"><i class="material-icons">mood</i></h2>
